...
CREATE TABLE `harvest` (
  ...
  `typeHarvest` varchar(100) DEFAULT NULL,
  `dateHarvested` date DEFAULT NULL,
  `quantityHarvested` int(11) DEFAULT NULL,
  `quality` varchar(50) DEFAULT NULL,
  `destiny` varchar(100) DEFAULT NULL,
  `registeredHarvest` tinyint(1) DEFAULT NULL,
...
INSERT INTO `harvest` VALUES (1,'Zanahoria','2025-04-10',82,'Secundaria','Limon',1,'zanahorias el amarillo'),(3,'Banano','2025-01-09',16,'Premium','LImon',1,'banano el monte azul');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_deleteHarvest` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_deleteHarvest`(IN p_idHarvest INT)
BEGIN
    DELETE FROM harvest WHERE idHarvest = p_idHarvest;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_getHarvest` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_getHarvest`()
BEGIN
    SELECT 
        idHarvest AS id,
        typeHarvest AS type,
        dateHarvested AS date,
        quantityHarvested AS quantity,
        quality,
        destiny,
        registeredHarvest AS registered,
        description
    FROM harvest;
END ;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_updateHarvest` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_updateHarvest`(
    IN p_idHarvest INT,
    IN p_typeHarvest VARCHAR(100),
    IN p_dateHarvested DATE,
    IN p_quantityHarvested INT,
...
BEGIN
    UPDATE harvest
    SET
        typeHarvest = p_typeHarvest,
        dateHarvested = p_dateHarvested,
        quantityHarvested = p_quantityHarvested,
        quality = p_quality,
        destiny = p_destiny,
        registeredHarvest = p_registeredHarvest,
        description = p_description
    WHERE idHarvest = p_idHarvest;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2025-04-28 21:53:24
