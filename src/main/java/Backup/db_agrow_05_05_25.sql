...
INSERT INTO `requests` VALUES (1,'Puerto Viejo, Sarapiquí',5,'2025-04-08','Necesito 5 sacos de papas','Ciany Amador Solís','6067-2363','Pendiente','Papas'),(2,'La Aurora, Heredia',20,'2025-03-04','Se necesita 20 quintales de maíz','Celia García Madrigal','2690-4520','Aprobada','Maíz');
...
INSERT INTO `supply` VALUES (1,'Maíz Criollo','Semillas',150.00,50.00,'Kilogramo (Kg)',120.00,'2025-09-30',45612375),(2,'Frijol Negro','Semillas',40.00,60.00,'Kilogramo (Kg)',100.00,'2025-10-15',45636520),(3,'Semilla de Tomates','Semillas',200.00,100.00,'Paquete',500.00,'2025-12-01',45612375),(4,'Semilla de Lechuga','Semillas',30.00,20.00,'Paquete',300.00,'2025-03-20',45636520),(5,'Sorgo','Semillas',20.00,30.00,'Kilogramo (Kg)',90.00,'2025-08-01',45612375),(6,'Fert. N-P-K 10-10-10','Fertilizantes',120.00,80.00,'Saco',2500.00,'2025-09-30',45636520),(7,'Fertilizante Orgánico','Fertilizantes',50.00,60.00,'Saco',3000.00,'2025-01-31',45612375),(8,'Microelementos','Fertilizantes',200.00,150.00,'Paquete',1800.00,'2025-09-30',45636520),(9,'Insecticida Orgánico','Plaguicidas',75.00,50.00,'Litro (L)',1500.00,'2025-05-31',45612375),(10,'Herbicida Selectivo','Plaguicidas',30.00,40.00,'Litro (L)',2000.00,'2025-09-30',45636520),(11,'Fungicida Preventivo','Plaguicidas',60.00,60.00,'Litro (L)',1750.00,'2025-03-10',45612375),(12,'Azada de Mano','Herramientas',15.00,10.00,'Unidad',8000.00,'2025-09-30',45636520),(13,'Machete 30cm','Herramientas',8.00,5.00,'Unidad',12000.00,'2025-09-30',45612375),(14,'Rastra Manual','Herramientas',3.00,5.00,'Unidad',15000.00,'2025-09-30',45636520),(15,'Carretilla','Herramientas',2.00,1.00,'Unidad',45000.00,'2025-09-30',45612375),(16,'Tubo PVC 1/2 pulg.','Accesorios de riego',100.00,50.00,'Metro (m)',250.00,'2025-09-30',45636520),(17,'Conector en T 1/2','Accesorios de riego',200.00,100.00,'Unidad',50.00,'2025-09-30',45612375),(18,'Aspersor Ajustable','Accesorios de riego',25.00,20.00,'Unidad',1200.00,'2025-09-30',45636520),(19,'Compost','Insumos orgánicos',20.00,10.00,'Saco',5000.00,'2025-04-30',45612375),(20,'Humus de Lombriz','Insumos orgánicos',15.00,15.00,'Saco',7000.00,'2025-05-15',45636520),(21,'Estiércol Seco','Insumos orgánicos',5.00,10.00,'Saco',3000.00,'2025-09-30',45612375),(22,'Guantes de Trabajo','Otros',50.00,20.00,'Paquete',1000.00,'2025-09-30',45636520),(23,'Gafas de Seguridad','Otros',30.00,15.00,'Unidad',2500.00,'2025-09-30',45612375),(24,'Rollo de Cuerda 50m','Otros',10.00,5.00,'Rollo',2000.00,'2025-09-30',45636520),(25,'Cinta Medicinal','Otros',100.00,100.00,'Caja',500.00,'2025-09-30',45612375);
...
CREATE TABLE `tb_harvest` (
  `id_harvest` int(11) NOT NULL AUTO_INCREMENT,
  `date_harvested` date DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL,
  `destiny` varchar(100) DEFAULT NULL,
  `quality` varchar(50) DEFAULT NULL,
  `quantity_harvested` int(11) DEFAULT NULL COMMENT 'Cantidad total original cosechada',
  `available_quantity` int(11) NOT NULL DEFAULT 0 COMMENT 'Cantidad disponible para la venta',
  `registered_harvest` bit(1) NOT NULL,
  `type_harvest` varchar(50) DEFAULT NULL,
  `id_producer` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_harvest`),
  KEY `fk_harvest_producer_idx` (`id_producer`),
  CONSTRAINT `fk_harvest_producer` FOREIGN KEY (`id_producer`) REFERENCES `producer` (`id_producer`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `tb_harvest` VALUES (1,'2025-04-29','Cosecha matutina, buen tamaño','Guapiles','Premium',23,13,_binary '','Zanahoria',90106),(2,'2024-01-02','Fruta grande y dulce','Jamaica','Secundaria',77,77,_binary '','Papaya',90106),(5,'2025-04-28','Listos para mercado local','Limon','Premium',20,20,_binary '','Chayote',90106),(7,'2025-04-30','Pequeñas pero sabrosas','Pococi','Secundaria',7,7,_binary '','Fresas',90106),(8,'2002-02-12','Grano de altura','Guacimo','Estándar',20,20,_binary '','Cafe',58062),(11,'2025-04-29','Peras jugosas','Guapiles','Premium',15,15,_binary '','Pera',58062),(12,'2004-02-21','Cosecha temprana','Guacimo','Estándar',5,5,_binary '','Mamon',90106);
...
CREATE TABLE `tb_sales` (
  ...
  `id_harvest` int(11) NOT NULL COMMENT 'FK a la cosecha vendida',
  `quantity_sold` int(11) NOT NULL COMMENT 'Cantidad vendida en esta transacción (ej: kg)',
  `sale_date` date NOT NULL COMMENT 'Fecha en que se realizó la venta',
  `buyer_name` varchar(100) NOT NULL COMMENT 'Nombre del comprador',
  `buyer_phone` varchar(15) DEFAULT NULL COMMENT 'Teléfono del comprador',
  `buyer_address` varchar(255) DEFAULT NULL COMMENT 'Dirección del comprador',
  `transport_option` varchar(100) DEFAULT NULL COMMENT 'Descripción del método de transporte',
  `price_per_unit_sold` decimal(10,2) NOT NULL COMMENT 'Precio por unidad (kg) al momento de la venta',
  `total_sale_amount` decimal(12,2) NOT NULL COMMENT 'Monto total calculado (quantity_sold * price_per_unit_sold)',
  PRIMARY KEY (`id_sale`),
  KEY `fk_sales_harvest_idx` (`id_harvest`),
  CONSTRAINT `fk_sales_harvest` FOREIGN KEY (`id_harvest`) REFERENCES `tb_harvest` (`id_harvest`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tb_sales` VALUES (1,1,10,'2025-05-01','Juan Garcia','88112233','Dirección 1','Retira Cliente',150.00,1500.00);
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `spDeleteSupplier`(IN in_supplier_identification INT)
BEGIN
  -- Primero, eliminar suministros asociados si existen (o marcar como inactivos, etc.)
  -- DELETE FROM supply WHERE supplierId = in_supplier_identification;
  -- O manejar en la aplicación antes de llamar este SP
...
WHERE id_machinaryrental = mr_id_machinaryrental;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    ...
    WHERE CAST(supplierIdentification AS CHAR) LIKE CONCAT('%', in_searchTerm, '%') -- Convertir ID a cadena para buscar
...
BEGIN
    ...
    FROM supply s
    LEFT JOIN supplier sp ON s.supplierId = sp.supplierIdentification
    WHERE (in_searchTerm IS NULL OR s.name LIKE CONCAT('%', in_searchTerm, '%'))
...
BEGIN
    ...
    FROM supply s
    LEFT JOIN supplier sp ON s.supplierId = sp.supplierIdentification
    WHERE s.stock <= s.stockMinimo AND s.stock > 0
...
BEGIN
    ...
    SELECT LAST_INSERT_ID() AS newIdSupply;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
  UPDATE supplier
    SET
      ...
      companyName       = in_company_name,
      phoneNumber          = in_phone_num,
      email              = in_email,
      registrationDate  = in_registration_date,
      isActive          = in_is_active,
      creditLimit       = in_credit_limit
    WHERE supplierIdentification = in_supplier_identification;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2025-05-05  4:00:59
